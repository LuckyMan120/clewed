...
<!-- Layout -->
  <!--div id="header-region" class="clear-block"><?php print $header; ?></div-->
    ...
    <div id="wrapper" class="page-user-password-wrapper">
    <div id="container" class="clear-block page-user-password-container">
...
<?php  //echo "<div class='divider' style='margin-top:10px;'></div>"; ?>  
      ...
      <div id="center"><div id="squeeze" ><div class="right-corner"><div class="left-corner" style='padding:0;margin:0'>
          ...
          <div class="clear-block">
            <?php
                  ...
                  print '<h2 style="padding-bottom: 10px;">Enter your user email to reset your password</h2>';
                  print ("<style>.messages {margin-top:20px !important;}</style>");
                  print ($content);
                  if($tab_box)echo "</div>";
                  echo "</div>";
	...
	<div id="footer" style="padding-top:20px;clear:both;" class="page-user-password-footer">
              <div class="divider">
